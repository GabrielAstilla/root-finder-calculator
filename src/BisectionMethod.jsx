      ...
      {results.length > 0 && (
        <div className="mt-8">
          ...
          <table className="w-full border-collapse border border-gray-800">
            ...
            <tbody>
              {results.map((iteration, index) => (
                <tr key={index}>
                  <td className="border border-gray-800 px-4 py-2">{iteration.iteration}</td>
                  <td className="border border-gray-800 px-4 py-2">{iteration.xl}</td>
                  <td className="border border-gray-800 px-4 py-2">{iteration.xm}</td>
                  <td className="border border-gray-800 px-4 py-2">{iteration.xr}</td>
                  <td className="border border-gray-800 px-4 py-2">{iteration.yl}</td>
                  <td className="border border-gray-800 px-4 py-2">{iteration.ym}</td>
                  <td className="border border-gray-800 px-4 py-2">{iteration.yr}</td>
                </tr>
              ))}
            </tbody>
          </table>
          <div className="mt-4">
            <h2 className="text-lg font-bold">Root: {results[results.length - 1].xm}</h2>
            <h2 className="text-lg font-bold">f(x): {results[results.length - 1].ym}</h2>
          </div>
        </div>
      )}
    </div>
